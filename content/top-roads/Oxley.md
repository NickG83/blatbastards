...
finish: Walcha
highlights:
  - item: Start near sea level, finish on the tablelands.
  - item: Great road camber in many sections.
warnings:
  - item: Avoid peak weekends if possible; caravans, cops, all the usual PITA road
      users that limit your fun
  - item: Fatigue factor; many crashes happen in the last 20–30 km. Stop at Gingers
